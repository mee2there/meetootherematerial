...
import innovation.meetoothere.extras.Constants;
import innovation.meetoothere.pojo.Movie;

import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_AUDIENCE_SCORE;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_CAST;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_ID;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_LINKS;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_MOVIES;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_POSTERS;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_RATINGS;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_RELEASE_DATES;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_REVIEWS;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_SELF;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_SIMILAR;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_SYNOPSIS;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_THEATER;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_THUMBNAIL;
import static innovation.meetoothere.extras.Keys.EndpointBoxOffice.KEY_TITLE;
