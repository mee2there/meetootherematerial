package innovation.meetoothere.activities;
...
import innovation.meetoothere.anim.AnimationUtils;
import innovation.meetoothere.extras.SortListener;
import innovation.meetoothere.fragments.FragmentBoxOffice;
import innovation.meetoothere.fragments.FragmentDrawer;
import innovation.meetoothere.fragments.FragmentFeed;
import innovation.meetoothere.fragments.FragmentMyEvents;
import innovation.meetoothere.fragments.FragmentSearch;
import innovation.meetoothere.fragments.FragmentUpcoming;
import innovation.meetoothere.logging.L;
import innovation.meetoothere.R;
import innovation.meetoothere.services.ServiceMoviesBoxOffice;
...
public class ActivityMain extends ActionBarActivity implements MaterialTabListener, View.OnClickListener {
    ...
    private void setupFAB() {
        ...
        ImageView iconNew = new ImageView(this);
        iconNew.setImageResource(R.drawable.ic_action_organize_new);
        ImageView iconEdit = new ImageView(this);
        iconEdit.setImageResource(R.drawable.ic_action_organize_edit);
        ...
        SubActionButton buttonNew = itemBuilder.setContentView(iconNew).build();
        SubActionButton buttonEdit = itemBuilder.setContentView(iconEdit).build();


        //to determine which button was clicked, set Tags on each button
        buttonNew.setTag(TAG_SORT_NAME);
        buttonEdit.setTag(TAG_SORT_DATE);
